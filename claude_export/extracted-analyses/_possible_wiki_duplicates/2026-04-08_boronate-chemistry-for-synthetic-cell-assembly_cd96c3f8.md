...
conversation_uuid: cd96c3f8-366b-4af5-b080-4ec0cada00a4
title: "-> Boronate chemistry for synthetic cell assembly"
created_at: 2026-04-08T00:16:48.850306Z
updated_at: 2026-05-10T23:40:52.928811Z
tier: A
score: 242
n_messages: 2
---

# -> Boronate chemistry for synthetic cell assembly
...
**Boronic acid (BA) + catechol chemistry**
Boronic acid groups have a hungry trigonal-planar boron atom that accepts electron pairs from hydroxyl groups on catechols (a diol arranged on an aromatic ring). The resulting boronate ester bond forms within seconds at neutral-to-basic pH and reverts in acidic conditions or excess competing diol. It's labile and adaptive — the chemistry "breathes." Analogy: think of it like a USB-C connector that plugs and unplugs itself automatically as voltage changes, always finding the lowest-energy connection.

**Membranized Coacervate Microdroplets (MCM)**
The target object: a coacervate droplet (crowded liquid interior) surrounded by a stabilizing shell — the synthetic cell model. Prior art required forming the core first, then applying the membrane separately.
